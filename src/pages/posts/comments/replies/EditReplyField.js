...
export default class EditReplyField extends Component{
...
myDropzone.addFile(file);
  ...
  render(){
   ...
   const {reply,open4Edit,handleDiscardChanges,onChange,handleSaveChanges,handleAddedFile,handleRemovedFile}=this.props
   const eventHandlers = { 
    ...
    <Confirm
          ...
          content='This reply appears to be blank. Please write something or attach a photo to post.'
          open={open4Empty}
